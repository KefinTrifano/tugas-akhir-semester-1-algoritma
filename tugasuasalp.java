...
// Tampilan Awal
		...
		System.out.println();
		System.out.println("\t\t\t\t\t\t==========================================");
		System.out.println("\t\t\t\t\t\t=Assalamualaikum warahmatulahi Wabarakatu=");
...
// Masukkan Username dan Password
		...
		if(username.equals(data[0])&&password.equals(data[1])){
			...
			System.out.println("=                                           =");
			System.out.println("=            Selamat Datang Di              =");
			System.out.println("=      Program Menghitung Volume Bangun     =");
...
// Pemilihan di menu awal
	...
	static void menu(){
		...
		String menu_utama[]={"Mulai Program","Materi yang di gunakan","Profil Pemrogram","Keluar"};
		...
		if(menu==1){
			...
			materi_yang_di_gunakan();
		}else if(menu==3){
			profil();
		}else{
			System.out.println();
			System.out.println("Terima Kasih Telah melakukan perhitung");
	...
	static void mulai(){
		...
		switch(menu2){
			...
			case 1 :
					...
					System.out.println("=======================================");
					System.out.println();
					System.out.print("\tMasukkan Sisi nya = ");
			...
			case 3 :
					...
					System.out.println("=======================================");
					System.out.println();
					System.out.print("\tMasukkan Luas Alas nya = ");
			...
			case 6 :
					...
					System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
					System.out.println("~                                                         ~");
					System.out.println("~       Terima Kasih Telah Berhitung Dan Berkunjung       ~");
					System.out.println("~                Sistem Sekarang Akan keluar              ~");
					System.out.println("~                    Keluar Dari Sistem                   ~");
					System.out.println("~                                                         ~");
					System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
...
// Materi yang di gunakan
	...
	static void materi_yang_di_gunakan(){

		System.out.println("Materi yang di gunakan yaitu:");
		System.out.println();
		System.out.println("\t1. Hello world");
		System.out.println("\t2. Tipe data varaiabel");
		System.out.println("\t3. Percabangan");
		System.out.println("\t4. Perulangan");
...
// Biodata Pemrogram
	...
	static void profil(){
		...
		System.out.println();
		System.out.println("Nama Saya : Kefin Trifano");
		System.out.println("TTL       : Lubuk anau,11 Maret 2002");
		...
		System.out.println();
		System.out.println("Sekian,Terima Kasih dan Jangan Lupa Semangat");
	}
	...
	static void next(){
		...
		int ulang;
		System.out.println();	
		System.out.print("Apakah Anda Ingin  Melakukan Perhitungan Kembali ? ( 1/0 ) = ");
		ulang=lagi.nextInt();
		if(ulang==1){
			mulai();
		}else{
	...
	static void penutup(){
		...
		System.out.println();
		System.out.println("\tTerima Kasih Telah Berkunjung Ke Program Kami");
		System.out.println("\tProses Telah Selesai");
		System.out.println("\tKeluar Dari Sistem");
		System.out.println("\tWassalamualaikum Warahmatullahi Wabarakatu");
	}	
}
